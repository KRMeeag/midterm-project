  ...
  return (
    <div className="min-h-[75vh] relative">
      ...
      <div className="relative flex w-full z-10">
        <div className="flex flex-col [&>*]:mx-10 md:mx-25 my-15 bg-base-100 h-full w-full min-h-[75vh] rounded-4xl shadow-2xl">
          <div className="flex flex-col md:flex-row justify-between mt-10 mb-3 items-center">
          ...
          {reservedList.length === 0 ? (
            ...
            <div className="flex flex-col mt-10 mb-3 items-center justify-center min-h-[45vh]">
            ...
            <div className="flex flex-col items-center my-3">
              {reservedList.map((reservedEntry) => (
                <ReservationEntry
                  key={reservedEntry.index}
                  {...reservedEntry}
                />
              ))}
            </div>
